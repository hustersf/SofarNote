...
/**
 * 边缘渐变消失效果，可以调整 fadeEdgeLength 的数值
 */
public class FadeEdgeTextView extends AppCompatTextView {
  ...
  private static class FadeEdgeHelper {
    ...
    public void saveCanvasLayer(Canvas canvas, int width, int height) {
      ...
      canvas.saveLayer(0, 0, fadeEdgeLength, height, null, Canvas.ALL_SAVE_FLAG);
      canvas.saveLayer(width - fadeEdgeLength, 0, width, height, null, Canvas.ALL_SAVE_FLAG);
    }

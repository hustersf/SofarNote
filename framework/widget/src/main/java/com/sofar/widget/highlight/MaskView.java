...
public class MaskView extends ViewGroup {
  ...
  public MaskView(Context context, AttributeSet attrs, int defStyle) {
    ...
    int dash = Util.dp2px(context, 4);
    mDashedPaint.setStrokeWidth(Util.dp2px(context, 2));
  ...
  protected void onDraw(Canvas canvas) {
    ...
    if (width == 0 || height == 0) {
      width = Util.getMetricsWidth(getContext());
      height = Util.getMetricsHeight(getContext()) + Util.getStatusBarHeight(getContext());
    }
